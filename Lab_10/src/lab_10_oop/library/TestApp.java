...
public class TestApp {
    public static void main(String[] args) throws ParseException {
        Item i1 = new Book("Bakien", 2001, 180);
        Item i2 = new Book("Moon", 2011, 150);
        ...
        rents[0] = new Rent(i1, s1, sdf.parse("18/01/2001"), sdf.parse("18/02/2001"));
