...
public class App {
        ...
        try {
            ...
            while ((line = dataReader.readLine()) != null) {
                ...
                if (dataList.get(5).equals("Africa")) {
                    countryManager.append(
                            new AfricaCountry(dataList.get(0), dataList.get(1), Integer.parseInt(dataList.get(2)),
                                    Double.parseDouble(dataList.get(3)), Double.parseDouble(dataList.get(4))));
                } else if (dataList.get(5).equals("Asia")) {
                    countryManager
                            .append(new AsiaCountry(dataList.get(0), dataList.get(1), Integer.parseInt(dataList.get(2)),
                                    Double.parseDouble(dataList.get(3)), Double.parseDouble(dataList.get(4))));
                } else if (dataList.get(5).equals("Europe")) {
                    countryManager.append(
                            new EuropeCountry(dataList.get(0), dataList.get(1), Integer.parseInt(dataList.get(2)),
                                    Double.parseDouble(dataList.get(3)), Double.parseDouble(dataList.get(4))));
                } else if (dataList.get(5).equals("North America")) {
                    countryManager.append(
                            new NorthAmericaCountry(dataList.get(0), dataList.get(1), Integer.parseInt(dataList.get(2)),
                                    Double.parseDouble(dataList.get(3)), Double.parseDouble(dataList.get(4))));
                } else if (dataList.get(5).equals("South America")) {
                    countryManager.append(
                            new SouthAmericaCountry(dataList.get(0), dataList.get(1), Integer.parseInt(dataList.get(2)),
                                    Double.parseDouble(dataList.get(3)), Double.parseDouble(dataList.get(4))));
                } else if (dataList.get(5).equals("Oceania")) {
                    countryManager.append(
                            new OceaniaCountry(dataList.get(0), dataList.get(1), Integer.parseInt(dataList.get(2)),
                                    Double.parseDouble(dataList.get(3)), Double.parseDouble(dataList.get(4))));
                }
    ...
    public static void init() {
        String filePath = "src/Hw6/Ex_5/countries.csv";
